...
APPSTORE_ANALYTICS_ENABLED: bool = _get_bool_optional("APPSTORE_ANALYTICS_ENABLED", True)
APPSTORE_ANALYTICS_START_DATE: str = _get_optional("APPSTORE_ANALYTICS_START_DATE") or "2026-07-16"
APPSTORE_ANALYTICS_HOUR: int = min(23, max(0, _get_int_optional("APPSTORE_ANALYTICS_HOUR", 9)))
APPSTORE_ANALYTICS_MINUTE: int = min(59, max(0, _get_int_optional("APPSTORE_ANALYTICS_MINUTE", 0)))
APPSTORE_ANALYTICS_TIMEZONE: str = _get_optional("APPSTORE_ANALYTICS_TIMEZONE") or "Europe/Minsk"
ADAPTY_SECRET_KEY: str | None = _get_optional("ADAPTY_SECRET_KEY")
